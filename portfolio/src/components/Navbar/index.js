        ...
        <SideNav style={{ backgroundColor: 'rgb(110, 55, 149)', opacity: 0.9 }}>
            ...
            <SideNav.Nav defaultSelected="about">
                ...
                <NavItem eventKey="resume">
                    <NavIcon>
                        <a href='https://docs.google.com/document/d/1MVuJxW494eAKX1W6SvwsmSc9zPWj18lXjd0-1KWzzYE/edit?usp=sharing' target='_blank' rel="noreferrer">
                    ...
                    <NavText><a href='https://docs.google.com/document/d/1MVuJxW494eAKX1W6SvwsmSc9zPWj18lXjd0-1KWzzYE/edit?usp=sharing' target='_blank' rel="noreferrer" style={{ color: 'rgb(229,199,208)', textDecoration: 'none' }}>
                        Resumé
            </a></NavText>
                </NavItem>
            </SideNav.Nav>
